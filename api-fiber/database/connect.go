...
// ConnectD creates a connection with the database.
func ConnectD() (db *sql.DB) {
	...
	*/
	...
	db.SetConnMaxLifetime(time.Minute * 3) // Maximum lifetime of a connection in minutes
